export default class Controller {
    ...
    editPerson(e){
        ...
        if(target.id == 'del_person'){
            ...
            let id = target.name;
            this.model.editPersonName(id, this.view.getText("get new Last Name"));
            this.view.printPersons(this.model.persons);
        }else if(target.id = 'edit_number'){
            this.model.editNamber(target.name[0], parseInt(target.name[1]),this.view.getText("get new number"));
            this.view.printPersons(this.model.persons);
        }else {
            return;
        }
